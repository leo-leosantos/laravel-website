                    ...
                    <div class="card-body">
                        ...
                        <form class="form-group" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text"
                                        id="blog-tags"  data-role="tagsinput"
                                        name="blog_tags" value="{{ $blog->blog_tags }}"
                                    >
                                    @error('blog_tags')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img class="rounded avatar-lg"
                                        src="{{ asset($blog->blog_image) ??  url('upload/no_image.jpg') }}"
                                    alt="" id="showImage">
                                </div>
                            </div>
                            <input type="submit" value="Update Blog Page"
